...
neural_net_model = MLPClassifier( hidden_layer_sizes=(76),random_state=42,tol=0.005)
...
print("\nThe two most incorectly identified letters and 'D' and 'H'")
print("Thank you for watching my project!")